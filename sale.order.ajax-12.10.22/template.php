...
else
{
  ...
  <link rel="stylesheet" href="/bitrix/templates/bejet_seller-1.6.0/components/bitrix/sale.order.ajax/antek/antech/page.css">
  <link rel="stylesheet" href="/bitrix/templates/bejet_seller-1.6.0/components/bitrix/sale.order.ajax/antek/antech/template.css">
		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="col-sm-8 bx-soa">
				...
				<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active">
					<div class="bx-soa-section-title-container">
						<h2 class="bx-soa-section-title"><?=$arParams['MESS_REGION_BLOCK_NAME']?>: <span class="bx-soa-section-title-content" id="locationPlaceName"></span></h2>
				...
				<? if ($arParams['BASKET_POSITION'] === 'after'): ?>
					...
					<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active hidden">
						<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title"><?=$arParams['MESS_BASKET_BLOCK_NAME']?></h2>
